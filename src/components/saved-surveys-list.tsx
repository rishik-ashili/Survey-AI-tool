                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex gap-2">
                      <Button variant="ghost" size="icon" onClick={() => setAttemptingSurvey(survey)}>
                        <PlayCircle />
                        <span className="sr-only"><TranslatableText>Attempt Survey</TranslatableText></span>
                      </Button>
                      {isAdmin && (
                        <>
                          <Button variant="ghost" size="icon" onClick={() => setViewingResults(survey)}>
                            <BarChart2 />
                            <span className="sr-only"><TranslatableText>View Results</TranslatableText></span>
                          </Button>
                          <AlertDialog>
                            <AlertDialogTrigger asChild>
                              <Button variant="ghost" size="icon" className="text-destructive hover:bg-destructive/10 hover:text-destructive">
                                <Trash2 />
                                <span className="sr-only"><TranslatableText>Delete Survey</TranslatableText></span>
                              </Button>
                            </AlertDialogTrigger>
                            <AlertDialogContent>
                              <AlertDialogHeader>
                      ...
                      <CollapsibleTrigger asChild>
                        <Button variant="ghost" size="icon">
                          ...
                          <span className="sr-only"><TranslatableText>Toggle Preview</TranslatableText></span>
                        </Button>
                      </CollapsibleTrigger>
                    </div>
                  </div>
